...
use crate::render::ghost::GhostMaterialAsset;
...
impl RenderAsset for GpuGhostRenderPipeline {
    ...
    type Param = (SRes<AssetServer>, SResMut<PipelineManager>, SRes<CameraFeatureRender>, SRes<RenderAssets<GpuMaterial<GhostMaterialAsset>>>);
