...
use crate::render::grid::{
    buffers::{TerrainGridBuffer, TerrainGridBufferBinding},
    terrain_grid_pipeline::TerrainGridRenderPipeline,
...
impl Plugin for TerrainGridPassesPlugin {
    fn build(&self, app: &mut App) {
        ...
        app.add_plugins((
            RenderDataRegisterPlugin::<TerrainGridBuffer>::default(),
            RenderBindingRegisterPlugin::<TerrainGridBufferBinding>::default()
        ));
