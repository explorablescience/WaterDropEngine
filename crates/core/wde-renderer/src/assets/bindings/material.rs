...
pub struct Material3d<M: RenderBindingOld>(pub Handle<M>);
...
pub trait Material: RenderBindingOld + Sync + Send + Asset + Clone {}
...
pub type GpuMaterial<M> = GpuRenderBindingOld<M>;
