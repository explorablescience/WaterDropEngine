...
use crate::logic::{
    batches::BatchesPlugin,
    deferred_textures::{PbrDeferredTextures, PbrDeferredTexturesLayout},
    lights::LightsFeature,
    render_texture::{PbrRenderTexture, PbrRenderTextureBindGroup},
    ssbo::PbrSsboPlugin
};
...
impl Plugin for PbrLogicPlugin {
    fn build(&self, app: &mut App) {
        ...
        app.add_systems(Startup, PbrRenderTexture::create_texture)
        ...
        app.get_sub_app_mut(RenderApp)
            ...
            .add_systems(
                Render,
                PbrRenderTextureBindGroup::build_bind_group.in_set(RenderSet::BindGroups)
            );
