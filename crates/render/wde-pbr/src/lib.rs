...
//! - **Components**: [`components::lights`] defines [`DirectionalLight`], [`PointLight`],
//!   [`SpotLight`] with attenuation helpers and defaults.
...
//!     // Light
//!    commands.spawn((
//!         DirectionalLight { direction: Vec3::new(-1.0, -1.0, -0.5), ..Default::default() },
//!     ));
//!
//!     // Material + mesh
